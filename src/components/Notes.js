        ...
        <div className="modal-dialog">
          <div className="modal-content">
            ...
            <div className="modal-body">
              <div className='container my-3'>
                <div className="mb-3">
                  <input readOnly value={note.title} style={{ "backgroundColor": "#1987541a" }} name="title" type="text" className="form-control border border-success" id="title" placeholder="Title" />
                </div>
                <div className="mb-3">
                  <textarea readOnly value={note.description} style={{ "backgroundColor": "#1987541a" }} name="description" placeholder="Description" className="form-control border border-success" id="description" rows="8"></textarea>
                </div>
                <div className="mb-3">
                  <input readOnly value={note.tag}style={{ "backgroundColor": "#1987541a" }} name="tag" type="text" className="form-control border border-success" id="tag" placeholder="Tags" />
                </div>
              </div>
            </div>
            <div className="modal-footer">
